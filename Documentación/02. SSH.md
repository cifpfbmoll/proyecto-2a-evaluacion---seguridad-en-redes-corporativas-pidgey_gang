...
Para explorar las vulnerabilidades de nuestro servidor SSH utilizaremos Nmap, para ello usaremos una maquina Kali con nmap instalado, desde la cual analizaremos la maquina mediante la ip:
```
nmap <ip>
```
![Analisis Kali][img1]
[img1]: /Imagenes/AnalisisKali.jpg "Analisis Kali"
